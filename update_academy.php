...
if ($result->num_rows > 0) {
    ...
    echo "<table>
            <thead>
                <tr>
                    ...
                    <th>تحديث الأكاديمية</th>
                    <th>حذف الأكاديمية</th>
                </tr>
            </thead>
            <tbody>";
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td><button class='update-button' onclick='updateAcademy(".$row['AcademyID'].")'>تحديث</button></td>";
...
function updateAcademy(academyID) {
    // توجيه المستخدم إلى صفحة تحديث الأكاديمية مع إرسال معرف الأكاديمية كمعلمة في رابط الصفحة
    window.location.href = "update_academy.php?academyID=" + academyID;
}
</script>
