...
<div class="container">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <label for="national_id">رقم القومي:</label>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // استخراج رقم القومي المدخل من النموذج
        $national_id = $_POST["national_id"];

        // استعلام SQL للبحث عن اللاعب برقم القومي
        $sql = "SELECT * FROM external_academies WHERE NationalID = '$national_id'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>لم يتم العثور على أي لاعب بهذا الرقم القومي.</p>";
        }
